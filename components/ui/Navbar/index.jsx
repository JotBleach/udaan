        ...
        <header className="w-full fixed top-0 md:px-4 md:pt-1 left-0 z-50">
            <div className='w-full bg-udaanpurple md:rounded-lg drop-shadow-2xl'>
                <nav className="flex items-center justify-between custom-screen mx-auto px-4 py-2 md:flex-row">
                    <div className="flex items-center pr-4 justify-between w-full md:w-auto">
                        <Brand />
                        <div className="md:hidden">
                            ...
                            >
                                {state ? (
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="#A09FEF">
                                        <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                                    </svg>
                                ) : (
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#A09FEF" className="w-6 h-6">
                    ...
                    <div className={`flex-1 pb-3 mt-8 md:pb-0 md:mt-0 md:block ${state ? "" : "hidden"}`}>
                        <ul className="flex flex-col text-right justify-end space-y-2 text-white md:flex md:flex-row md:space-x-6 md:space-y-0 md:text-gray-600 md:font-medium">
                            {
